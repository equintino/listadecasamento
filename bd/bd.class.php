...
class Conexao extends PDO {
    ...
    public static function getInstance() {
        ...
        if(!isset( self::$instancia )){
            try {
                self::$instancia = new Conexao("mysql:host=sql113.byethost7.com;dbname=b7_16656868_helpdesk","b7_16656868","monica924");
    ...
    public static function atualizaBd($tabela,$dados,$where){
	...
	$sth = Conexao::getInstance() -> query("select * from cadastro where presenteador like '%$user%' ");
    ...
    public static function grava3Bd($tabela,$sql){
	$sth = Conexao::getInstance() -> prepare($sql);
	$sth -> execute();
    }
